...
class EventRecord(Base):
    ...
    config_version: Mapped[int | None] = mapped_column(Integer, nullable=True, index=True)
    ai_config_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
    caldav_config_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
    failure_phase: Mapped[str | None] = mapped_column(String(50), nullable=True, index=True)
